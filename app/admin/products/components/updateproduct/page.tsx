...
const FormSchema = z.object({
  ...
  discount_price: z.number().min(0, "Must be 0 or greater"),
  ...
  discount_price_b2b: z.number().min(0, "Must be 0 or greater"),
...
export default function UpdateProduct({ onSuccess }: { onSuccess?: () => void }) {
  ...
  useEffect(() => {
    const subscription = form.watch((value, { name }) => {
      const priceFields = ['base_price', 'tax', 'profit_price', 'shipping', 'discount_price'];
      ...
      if (priceFields.includes(name as string)) {
        ...
        const discount_percent = value.discount_price || 0;
  ...
  const subscription = form.watch((value, {name}) => {
    ...
    if(priceFields.includes(name as string)){
      ...
      const discountPercentB2B = value.discount_price_b2b || 0;
