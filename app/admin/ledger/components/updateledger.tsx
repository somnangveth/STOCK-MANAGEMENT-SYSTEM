...
import { fetchPurchaseOrders } from "@/app/admin/purchase/components/action/purchase-order";
...
const UpdateLedgerSchema = z
  .object({
    ...
    debit: z.coerce.number().positive("Total Amount must be greater than 0"),
    credit: z.coerce.number().nonnegative("Credit cannot be negative"),
