...
const POEditFormSchema = z.object({
  vendor_id: z.coerce.number().positive("Please select a vendor"),
                      ...
                      {!isNewItem && (
                        <div className="p-4 bg-blue-50 border border-blue-200 rounded">
                          <div className="grid grid-cols-3 gap-4">
                            <div>
                              <p className="text-xs text-blue-600 font-medium">Original Total</p>
                              <p className="text-lg font-bold text-blue-900">${originalItemTotal.toFixed(2)}</p>
                            </div>
                            <div className="flex items-center justify-center">
                              {itemChanged && <p className="text-2xl text-blue-600">→</p>}
                            </div>
                            <div>
                              <p className="text-xs text-blue-600 font-medium">New Total</p>
                              <p className={`text-lg font-bold ${itemChanged ? "text-green-600" : "text-blue-900"}`}>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <div className="font-medium">
                    <span className={subtotalChanged ? "text-green-600" : ""}>
                      ${subtotal.toFixed(2)}
                    </span>
                    {subtotalChanged && (
                ...
                <div className="flex justify-between text-lg font-bold pt-2 border-t">
                  <span>Total:</span>
                  <div>
                    <span className={subtotalChanged ? "text-green-600" : "text-blue-600"}>
                      ${total.toFixed(2)}
                    </span>
                    {subtotalChanged && (
                      <span className="text-xs text-gray-600 ml-2">
