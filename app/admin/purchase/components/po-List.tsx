...
import { fetchPurchaseOrders, deletePurchaseOrder, fetchPurchaseOrder } from "../components/action/purchase-order";
import { PurchaseOrder, PurchaseOrderDetail } from "@/type/productType";
import POEditForm from "./po-update";

const STATUS_CONFIG = {
  draft: { color: "bg-slate-100 text-slate-800", icon: "📝" },
  submitted: { color: "bg-blue-100 text-blue-800", icon: "📤" },
  confirmed: { color: "bg-purple-100 text-purple-800", icon: "✅" },
  received: { color: "bg-green-100 text-green-800", icon: "📦" },
  completed: { color: "bg-emerald-100 text-emerald-800", icon: "🎉" },
  cancelled: { color: "bg-red-100 text-red-800", icon: "❌" },
};

export default function POList({ refreshKey }: { refreshKey: number }) {
