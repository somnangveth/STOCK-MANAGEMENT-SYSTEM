// app/admin/purchase/components/receive-dialog.tsx
"use client";
...
import { receivePurchaseOrder } from "./action/receive";
...
export default function ReceiveDialog({ po, onSuccess, onCancel }: ReceiveDialogProps) {
  ...
  const hasChanges = items.some(
    (item, idx) => 
      ...
      item.batch_id !== (po.purchase_items[idx].batch_id || "") ||
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-3">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        value={item.batch_id}
                        onChange={(e) =>
                          handleItemChange(index, "batch_id", e.target.value)
                        }
                        className="border-gray-300"
